 ...
 *
 * @Title: ServiceAreaRequestDTO
 * @Prject: shopping
 * @Package: com.sunshine.shopping.model.dto
 * @Description: <功能详细描述>
 * @author: LiMG
 * @date: 2017/8/30 11:16
 * @version: V1.0
 */
 ...
 * @since [产品/模块版本]
 */
public class ServiceAreaRequestDTO implements Serializable {

    private static final long serialVersionUID = 5832420263787894283L;
